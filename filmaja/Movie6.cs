...
namespace filmaja
{
    public partial class Movie6 : Form
    {
        public Movie6()
        {
            InitializeComponent();
        ...
        int hihi = 0;
        int huhu = 0;
        private void Movie6_Load(object sender, EventArgs e)
        {
            ...
            pictureBox1.ImageLocation = ("D:\\Foto tugas uc\\The_conjuring_l_evocazione_copertina.jpg");
